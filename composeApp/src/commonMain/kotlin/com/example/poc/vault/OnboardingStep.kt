...
val ONBOARDING_STEPS = listOf(
    OnboardingStep(
        ...
        description = "Set Vault as your Autofill provider so Android can fill and save passwords with one system prompt.",
    ...
    OnboardingStep(
        ...
        description = "On Android 14 and newer, you can also expose Vault as a Credential Manager fill provider alongside the standard Autofill flow.",
